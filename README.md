...
`Ver: 2.0` → leggi [Changelog Versione 2 per sapere cosa è cambiato](CHANGELOG_VERSIONE2.md)
...
Ogni file è scritto con sintassi **Markdown**. Per evitare differenze tra editor e CI, formatta i file con `make lint-fix` o con `mdformat --extensions space_control --no-validate`. Il repository configura `markdownlint` per accettare l'indentazione prodotta da `mdformat`:
